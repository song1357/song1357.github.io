...
<div class="">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
        <div class="container">
            ...
            <div class="button">
                <a href="#" @click="isActive = !isActive"  :key="first" :class="{ btnOpen: !isActive, btnClose: isActive }"></a>
            </div>
            <div :class="{ overlay: isActive}" v-show="isActive">
                <div class="wrap">
                    <ul class="wrap-nav">
                        <li>
                            <a href="#">About</a>
